...
AS
SELECT    o.ID, o.进货日期, o.货号, o.商品图片, o.进货数量, o.店铺ID, o.JD订单号, o.客人地址, o.淘宝账号ID, o.淘宝订单号, o.采购备注, o.订单修改备注, o.来快递单号, o.发货时间, o.京东价, 
               o.成本价, o.采购人ID, o.导入时间, o.是否能等, o.电话客服备注, o.审单操作ID, o.拆包人员备注, o.转发单号, o.拆包人ID, o.拆包时间, o.售后操作ID, o.售后原因ID, o.售后备注, o.售后人员ID, 
               o.售后时间, o.客人退回单号, o.是否淘宝退回, o.售后完结, s.Name AS [店铺.Name], cg.Name AS [采购人.Name], tb.Name AS [淘宝账号.Name], sd.Name AS [审单操作.Name], 
...
FROM       dbo.订单 AS o LEFT OUTER JOIN
               ...
               dbo.Users AS sh ON sh.ID = o.售后人员ID
GO
