...
SELECT  o.ID, o.进货日期, o.货号, o.规格, o.商品图片, o.进货数量, o.入库数量, o.店铺, o.JD订单号, o.客人姓名, o.客人电话, o.客人地址, o.淘宝账号, o.淘宝订单号, 
               ...
               o.客人退回单号, o.售后完结, o.客服ID, o.客服时间, o.高亮, o.现货, o.退款金额, o.中转仓, o.在途待发, cg.Name AS [采购人.Name], 
               sd.Name AS [审单操作.Name], sd.入库 AS [审单操作.入库], cb.Name AS [拆包人.Name], sho.Name AS [售后操作.Name], sho.SN AS [售后操作.SN], 
               shr.Name AS [售后原因.Name], shr.SN AS [售后原因.SN], sh.Name AS [售后人员.Name], gj.Name AS [跟进人.Name], kf.Name AS [客服.Name], 
